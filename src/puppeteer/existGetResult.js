...
async function existGetResult(userId, userData) {
  ...
  try {
    // 보장선택(운전저범위, 생년월일)
    await page.waitForSelector('#row_9 > td:nth-child(3)', {
      timeout: 5000,
    })
    await page.click('#row_9 > td:nth-child(3)')
    await page.click(`#${carInfo.range}`)
    await page.click(`#row_10 > td:nth-child(3)`)
    await page.click(
    ...
    if (carInfo.range === 'famradio02' || carInfo.range === 'famradio04') {
      await page.click('#row_11 > td:nth-child(3)')
      await page.click(
    ...
    // 보장선택(option 1~8)
    await page.click(`#row_2 > td:nth-child(3)`)
    await page.click(`#${carInfo.option2}`)
    await page.click(`#row_3 > td:nth-child(3)`)
    await page.click(`#${carInfo.option3}`)
    await page.click(`#row_5 > td:nth-child(3)`)
    await page.click(`#${carInfo.option5}`)
    await page.click(`#row_6 > td:nth-child(3)`)
    await page.click(`#${carInfo.option6}`)
    await page.click(`#row_7 > td:nth-child(3)`)
    await page.click(`#${carInfo.option7}`)
    await page.click(`#row_8 > td:nth-child(3)`)
    await page.click(`#${carInfo.option8}`)
    await page.click(`#row_4 > td:nth-child(3)`)
    if (
